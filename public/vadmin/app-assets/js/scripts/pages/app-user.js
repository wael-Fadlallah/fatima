...
$(document).ready(function () {
  ...
  var customBulletHTML = function (params) {
    ...
    if (params.value == true) {
      color = "success"
      return "<span class='text-success'>تم التحقق </span>"
    } else if (params.value == false) {
      color = "secondary";
      return "<span class='text-danger'>لم يتم التحقق </span>"
    }
  }
  ...
  var customIconsHTML = function (params) {
    ...
    var editIconHTML = "<a href='users/"+params.data.id+"/edit'><i class= 'users-edit-icon feather icon-edit-1 mr-50'></i></a>"
  ...
  var customAvatarHTML = function (params) {
    return "<span class='avatar'><img src='" + params.data.avatar + "' height='32' width='32'></span>"
  }
