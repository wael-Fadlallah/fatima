...
class Form extends Component
{
    ...
    protected $rules = [
        ...
        'idendtaty' => 'required|digits:10|numeric',
    ...
    {
        $this->reset('name', 'phone', 'birthday', 'shift', 'lavel_id', 'class_id');
    }
...
//        $this->upadteData->update($data);
    ...
    {
        return view('livewire.admin.studens.form', ['levels' => Level::all(), 'classes' => ClassModel::all()]);
    }
}
