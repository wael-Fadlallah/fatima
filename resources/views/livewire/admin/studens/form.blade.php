...
<div>
    ...
    <div class="row m-3">
        ...
        {{--        </div>--}}
        <div class="col-12">
            <lable class="col-12"> الحلقه </lable>
            <div class="input-group ">

                <select type="text" name="class_id" wire:model="class_id" class="form-control col-12"
                >
                    <option value="0">إختر الحلقه</option>
                ...
                @error('class_id') <p class="col-12"><span class="error text-danger">{{ $message }}</span></p> @enderror
