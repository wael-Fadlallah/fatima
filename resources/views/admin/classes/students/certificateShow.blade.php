    ...
    <div class="container" dir="rtl" id="cer" style="margin: 0px 50px;">
        ...
        <div class="row" style="justify-content:center;">
            <div class="text-center ">
                <h2 style=" margin-right:0px; "> شهادة إجتياز مستوى </h2>
                الفصل الدراسي الثاني لعام {{$result->result->year->year??''}} هـ
                <br>
        ...
        <div class="row justify-content-center" style="">
            ...
            <div style="margin: 0px 0px;width:80%;margin:auto">
                ...
                <div class="col-md-6 text-center" style="font-size:18px;">
                    المستوى
                    <span style="margin-right: 0px;"> : </span>
                    <label> {{ $result->student->classes->name??''}} </label>
                </div>
            </div>
        </div>
        ...
        <div class="row text-center" style="margin-top: 15px;">
            ...
            <div class="col-md-4">
                ...
                <div style="text-align: right;margin:0px;">
                    ...
                    {{$now = \GeniusTS\HijriDate\Date::today()->format('d o')??''}}
                    هـ
                </div>
