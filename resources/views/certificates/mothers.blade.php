        ...
        <div class="col-md-10">
            <table width='90%' style="margin: auto;" border="1" id="cer_table" >
                ...
                <tr>
                    ...
                    <td class="cell r_2_c_0" contenteditable='true'> 756 </td>
                    <td class="cell r_2_c_1" contenteditable='true' colspan="2"></td>
    ...
    <div class="row text-center" style="margin-top: 15px;" >
        <div class="col-md-4">
            <h5>
                ...
                <img src="{{asset('images/techers/1.png')}}" width="100px" style="display: block;margin:auto;margin-top:10px;" id="teacher_sign">
...
<script defer>
    ...
    function calc(){
        ...
        if( isNaN(r_cell_2) || isNaN(r_cell_1) || isNaN(r_cell_4) ){
            ...
            total = r_cell_2 + r_cell_1 + r_cell_4
        }
        ...
        if( isNaN(cell_3) || isNaN(cell_6) || isNaN(cell_12) ){
            ...
            var result = cell_6 + cell_3 + cell_12 ;
