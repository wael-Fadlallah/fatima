...
<div class="container" dir="rtl" style="" id="cer" style="">
    {{-- <div class="row" style="justify-content:right;">
        <div class="col-md-4 text-center ">
            <h2> إشعار </h2>
            الفصل الدراسي الأول لعام 1441هـ
            <br>
            مدرسة فاطمة بنت محمد الصباحية
        </div>
    </div> --}}
    ...
    <div class="row" style="margin-top: 10px;">
        ...
        <div class="col-md-10">
            <table width='100%' border="1" id="cer_table" >
                ...
                <tr>
                    <td> التجويد </td>
                    <td class="cell r_3_c_0" contenteditable='true'> 120 </td>
                ...
                <tr>
                    ...
                    <td class="cell r_4_c_0" contenteditable='true'> 40 </td>
                    <td class="cell r_4_c_1" contenteditable='true'></td>
                    <td class="cell r_4_c_2" contenteditable='true'></td>
...
<script defer>
    ...
    function calc(){
        ...
        if( isNaN(r_cell_2) || isNaN(r_cell_1) || isNaN(r_cell_3) || isNaN(r_cell_4) ){

        }else{
            total = r_cell_2 + r_cell_1 + r_cell_3 + r_cell_4
        }

        var cell_1 = parseInt( ( $(".r_1_c_1").html().replace("<br>",''))  );
        var cell_2 = parseInt( ( $(".r_1_c_2").html().replace("<br>",''))  );
        var cell_3 = $(".r_1_c_3");
        ...
        var cell_1 = parseInt( ( $(".r_2_c_1").html().replace("<br>",''))  );
        var cell_2 = parseInt( ( $(".r_2_c_2").html().replace("<br>",''))  );
        var cell_6 = $(".r_2_c_3");
        if( isNaN(cell_1) || isNaN(cell_2) ){
            // console.log("pass");
            // return false ;
        }else{
            cell_6.html( cell_1 + cell_2 );
        }

        var cell_1 = parseInt( ( $(".r_3_c_1").html().replace("<br>",''))  );
        var cell_2 = parseInt( ( $(".r_3_c_2").html().replace("<br>",''))  );
        var cell_9 = $(".r_3_c_3");
        if( isNaN(cell_1) || isNaN(cell_2) ){
            // console.log("pass");
            // return false ;
        }else{
            cell_9.html( cell_1 + cell_2 );
        }

        var cell_1 = parseInt( ( $(".r_4_c_1").html().replace("<br>",''))  );
        var cell_2 = parseInt( ( $(".r_4_c_2").html().replace("<br>",''))  );
        var cell_9 = $(".r_4_c_3");
        if( isNaN(cell_1) || isNaN(cell_2) ){
            // console.log("pass");
            // return false ;
        ...
        var cell_3 = parseInt( ( $(".r_1_c_3").html().replace("<br>",''))  );
        var cell_6 = parseInt( ( $(".r_2_c_3").html().replace("<br>",''))  );
        var cell_9 = parseInt( ( $(".r_3_c_3").html().replace("<br>",''))  );
        var cell_12 = parseInt( ( $(".r_4_c_3").html().replace("<br>",''))  );
        if( isNaN(cell_3) || isNaN(cell_6) || isNaN(cell_9) || isNaN(cell_12) ){

        }else{
            var result = cell_9 + cell_6 + cell_3 + cell_12 ;
